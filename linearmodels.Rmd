...
table1(~ ., data = agg[, .(BPAQ, BIS, age, NEOc, NEOo, gender)])
```
...
# Modified t-tests
- There is a version of the t-test which does not assume equal variances in the groups compared (Welch-modified)
